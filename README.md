...
* Download and install BioBB HPC Conda Pack (BioBB library + PyCOMPSs Workflow manager):
https://mmb.irbbarcelona.org/biobb/availability/condapacks

* Clone GitHub repository
git clone https://github.com/bioexcel/biobb_hpc_workflows.git

* Generate and modify HPC cluster/supercomputer configuration file from template in [sc_conf](https://github.com/bioexcel/biobb_hpc_workflows/sc_conf/sc_conf.git.yml):
